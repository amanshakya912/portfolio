...
const Contact = () => {
  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-6xl mx-auto px-6 font-karla z-10">
        <motion.h2
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          transition={{ duration: 0.6 }}
          className="text-3xl md:text-4xl text-center font-cormorant mb-4"
        >
          Contact Me
        </motion.h2>

        <div className="mx-auto mb-12 h-0.5 w-28 bg-gradient-to-r from-transparent via-cyan-400 to-transparent" />
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          >
            <div className="rounded-2xl bg-blue-950/85 backdrop-blur-xl
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                {state.succeeded && (
                  <p className="text-cyan-400 text-sm">Message sent successfully!</p>
                )}
              </form>
            </div>
          </motion.div>
          ...
          >
            ...
            <InfoRow icon={faEnvelope}>
              <a href="mailto:amanshakya9912@gmail.com" className="hover:text-cyan-300 transition">
                amanshakya9912@gmail.com
              </a>
            </InfoRow>
            <InfoRow icon={faPhone}>
              <a href="tel:+9779818313576" className="hover:text-cyan-300 transition">
                +977-9818313576
              </a>
            </InfoRow>
            ...
            <div className="flex justify-center md:justify-start gap-6 text-xl">
              <SocialLink href="https://github.com/amanshakya912" icon={faGithub} />
              <SocialLink href="https://linkedin.com/in/amanshakya912" icon={faLinkedin} />
            </div>
          </motion.div>
        </div>
