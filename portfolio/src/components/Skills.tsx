...
import {
  faJs, faPhp, faPython, faReact, faNodeJs,
  faHtml5, faCss3Alt, faBootstrap, faGitAlt,
  faDartLang, faFlutter, faDocker,
...
const Skills: React.FC = () => {
  ...
  return (
    <section id="Skills" className="py-16 bg-blue-950 relative overflow-hidden">
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 font-karla z-10">
        <motion.h2
          ...
          {skills[activeCategory].map((skill, index) => (
            <motion.div
              ...
              className="relative group cursor-pointer
                ...
                shadow-lg"
            >
              <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-cyan-400/20 to-blue-600/20 opacity-0 group-hover:opacity-100 transition-opacity blur-xl" />
              <FontAwesomeIcon
                icon={skill.icon}
