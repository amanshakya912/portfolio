  ...
  return (
    <div className="relative overflow-hidden h-screen w-full z-40">
      ...
      <div className="absolute inset-0 flex flex-col items-center md:justify-center top-[30%] md:top-0 text-center text-blue-950 z-50">
        ...
        <button className="animate-fade animate-once animate-duration-2000 animate-delay-1000 font-karla bg-blue-950 text-white text-xl px-6 py-4 mt-10 hover:bg-blue-900 cursor-pointer rounded-md">
            View Resume
        </button>
      </div>
